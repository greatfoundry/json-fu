(function() {
  ...
  exports.testThisThing = function() {
    var TestClass, json, testObjects;
    testObjects = [];
    ...
    testObjects.push({
      "already_quoted": "value"
    });
    testObjects.push(null);
    testObjects.push(void 0);
    TestClass = (function() {
      function TestClass(one) {
        this.one = one;
      }
      TestClass.static = "foo";
      return TestClass;
    })();
    testObjects.push(TestClass);
    testObjects.push(new TestClass("bar"));
    testObjects.push(testObjects[0]);
    testObjects.push(testObjects[3]);
    testObjects.push(testObjects);
    testObjects.push({
      a: "deeply",
      embedded: {
        object: "with",
    ...
    return console.log(exports.deserialize(json));
  };
}).call(this);
